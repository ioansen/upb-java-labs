...
import com.ioansen.java.Shape.Circle;
import com.ioansen.java.Shape.Rectangle;
import com.ioansen.java.Shape.Shape;
import com.ioansen.java.Shape.Square;
...
public class ShapeTest {
    ...
    public void shapeTest() {
        ...
        if(!circle.isFilled() || !circle.getColor().equals("green")) {
            ...
            ok = false;
        } else if(!square.isFilled() || !square.getColor().equals("black") || square.getWidth() != square.getHeight()) {
